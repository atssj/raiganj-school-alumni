...
import { Button, Logo, Copyright } from '../../../shared/components';
      ...
      >
        <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
          <div className="flex justify-between items-center">
            ...
            {/* Mobile Toggle */}
            <button
              className={`md:hidden p-2 transition-colors z-50 relative ${isMobileMenuOpen ? 'text-gray-900' : menuIconColor}`}
        ...
        >
          <div className="flex flex-col h-full overflow-y-auto">
            ...
            <div className="px-6 py-6 border-b border-gray-100 bg-gray-50/50">
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-[10px] uppercase tracking-[0.2em] font-medium text-gray-500 mt-1">
                    Alumni Network
                  </span>
                </div>
              </div>
            ...
            <div className="flex-1 py-6 px-4 space-y-1">
              ...
              <MobileNavLink 
                onClick={() => handleNavigate(ViewState.STORIES)} 
                icon={BookOpen}
              ...
              <MobileNavLink 
                onClick={() => handleNavigate(ViewState.DONATE)} 
                icon={Heart}
                color="text-rose-600"
                bgColor="bg-rose-50"
              >
              ...
              <MobileNavLink 
                onClick={() => handleNavigate(ViewState.VOLUNTEER)} 
                icon={HandHeart}
...
const MobileNavLink: React.FC<MobileNavLinkProps> = ({ onClick, children, icon: Icon, color, bgColor }) => (
  <button
    onClick={onClick}
