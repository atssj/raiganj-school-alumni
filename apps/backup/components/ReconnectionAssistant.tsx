...
import { generateReconnectionMessage } from '../services/geminiService';
...
export const ReconnectionAssistant: React.FC = () => {
  ...
  const [tone, setTone] = useState<'nostalgic' | 'professional' | 'casual'>('nostalgic');
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        <div className="p-6 md:p-8 border-b border-gray-100 bg-brand-50/50">
          ...
          <p className="text-sm md:text-base text-gray-600">
            Lost for words? Let our AI draft a warm message to reconnect with your old batchmate from Raiganj High.
          </p>
        </div>
        ...
        <div className="p-6 md:p-8 grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="space-y-4 md:space-y-6">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">Shared Memory (Optional)</label>
              <textarea
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {(['nostalgic', 'casual', 'professional'] as const).map((t) => (
                  <button
                    key={t}
                    onClick={() => setTone(t)}
            ...
            {generatedMessage ? (
              <div className="flex-1">
                ...
                <div className="mt-6 flex gap-2">
                    <Button size="sm" variant="outline" onClick={() => navigator.clipboard.writeText(generatedMessage)} className="flex-1 md:flex-none justify-center">
                        <Copy className="w-4 h-4 mr-2"/> Copy
                    </Button>
                    <Button size="sm" onClick={() => alert("Simulated: Message sent!")} className="flex-1 md:flex-none justify-center">
