...
export const Stories: React.FC = () => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        const newStory: StoryItem = {
            ...
            title,
            author: 'Rahul C.', // Currently logged in user mock
            batch: 2010,
            date: 'Just now',
            content,
            likes: 0,
        ...
        <div className="space-y-6 md:space-y-8 pb-12">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4">
                <div>
                    ...
                    <p className="text-gray-500 mt-1">Nostalgia, achievements, and memories from the corridors of Raiganj.</p>
                </div>
                ...
                <div className="bg-white p-6 rounded-2xl border border-brand-200 shadow-lg animate-fade-in relative z-10">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div>
                            ...
                            />
                            <p className="text-xs text-gray-400 mt-1">Tip: Use the AI button to fix grammar and enhance the nostalgic tone.</p>
                        </div>
                        <div className="flex justify-end gap-3 flex-col sm:flex-row">
                            <Button type="button" variant="ghost" onClick={() => setIsWriting(false)} className="w-full sm:w-auto">Cancel</Button>
                            <Button type="submit" className="w-full sm:w-auto">Publish Story</Button>
                        </div>
                    </form>
                </div>
            )}
